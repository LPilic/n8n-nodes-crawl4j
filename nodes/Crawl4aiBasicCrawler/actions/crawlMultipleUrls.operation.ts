  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Persist browser state across runs (set user data dir)',
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Apply stealth mode to evade basic bot detection',
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Disable images for faster text-only crawls',
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Turn off background features for performance',
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Enable verbose logs for debugging browser',
      },
    ],
  },
  {
